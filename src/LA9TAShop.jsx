...
const styles = {
  ...
  header: { display: "flex", justifyContent: "space-between", alignItems: "center", padding: "18px 30px" },
  ...
  main: { display: "grid", gridTemplateColumns: "1fr 320px", gap: 20, padding: 20 },
  ...
  side: { padding: 12, borderRadius: 12, background: "rgba(255,255,255,0.9)", boxShadow: "0 6px 18px rgba(0,0,0,0.15)", backdropFilter: "blur(10px)" },
  ...
  modal: { width: 520, background: "white", padding: 20, borderRadius: 12, boxShadow: "0 20px 60px rgba(0,0,0,0.3)" },
